...
Pliki `genres_chart.py`, `countries_chart.py`, `bands_name_len_chart.py`, `activity_chart.py`, `heatmap_chart.py` oraz `describe_genres_chart.py` odpowiadają za wizualizacje danych.
